...
public class Idiomas {
    ...
    public static String FILA_LLENA;
    public static String COLUMNA;
    public static String COLUMNA_INVALIDA;
    public static String COLUMNA_LLENA;
    public static String CASILLA_INVALIDA;
    ...
    public static void getInstance(String idioma) {
        ...
        switch (opcion) {
            case ESP:
                ...
                FILA_INVALIDA = "Fila inválida. Debe ser un número entre 1 y 3.";
                FILA_LLENA = "La fila seleccionada ya está llena. Por favor, seleccione otra fila.";
                COLUMNA = "Ingrese la columna (1-3): ";
                COLUMNA_INVALIDA = "Columna inválida. Debe ser un número entre 1 y 3.";
                COLUMNA_LLENA = "La columna seleccionada ya está llena. Por favor, seleccione otra columna.";
                CASILLA_INVALIDA = "La casilla seleccionada está ocupada. Intente de nuevo.";
            ...
            case ENG:
                ...
                TURNO = "Turn of ";
                FILA = "Enter row (1-3): ";
                FILA_INVALIDA = "Invalid row. Must be a number between 1 and 3.";
                FILA_LLENA = "The selected row is already full. Please select another row.";
                COLUMNA = "Enter column (1-3): ";
                COLUMNA_INVALIDA = "Invalid column. Must be a number between 1 and 3.";
                COLUMNA_LLENA = "The selected column is already full. Please select another column.";
                CASILLA_INVALIDA = "The selected column is already full. Please try again.";
            ...
            case JAP:
                ...
                TURNO = "の番です。";
                FILA = "行を入力してください (一-三): ";
                FILA_INVALIDA = "「無効な行です。1から3までの数字でなければなりません";
                FILA_LLENA = "「選択された行はすでに一杯です。別の行を選択してください";
                COLUMNA = "列を入力してください (一-三): ";
                COLUMNA_INVALIDA = "無効な列です。間の数字でなければなりません 一 そして 三";
                COLUMNA_LLENA = "選択した列は既に満杯です。別の列を選択してください。";
                CASILLA_INVALIDA = "選択したマスはすでに埋まっています。もう一度お試しください。";
